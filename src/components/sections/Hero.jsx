...
<div className="flex-1 text-center md:text-left">
  ...
  <div className="mt-8 space-y-6 max-w-2xl">
    <p className="text-2xl md:text-3xl font-medium text-gray-900 leading-tight">
      Final Year <span className="text-blue-400">Software Engineering</span> student at AUT, 
      specializing in full-stack systems and <span className="text-blue-400">interpretable AI</span>.
    </p>

    <p className="text-lg md:text-xl text-gray-800 leading-relaxed">
      Currently deep-diving into <span className=" text-gray-400 hover:text-gray-700 border-b border-gray-800 pb-0.5">Machine Learning</span> and 
      automated <span className="text-gray-400 hover:text-gray-700 border-b border-gray-800 pb-0.5">Web Scraping</span> to create 
